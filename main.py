...
def handle_guild_batch_command(account_name, args):
    ...
    if cmd is None or not cmd.batchable:
        ...
        print("可用: gen, init, join/j, approve, donate/d, daily, da, defda, jq, yl, tf, xyx, wk, dy, kg, kgtest/kgt, grc, ghgrc, fl, fl31, mr, ndrwlq, check, k, i, status/s, run, xs, xsacp, xsinit, xsgrrw, xsacpb, xs12r, xst, xs123r, zscp, pipeline")
        return False
